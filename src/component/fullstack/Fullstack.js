...
import { FAQ_auery } from "./fullstackmockdata.js";
...
import Fullstackaccoridon from "./Fullstackaccoridon.js";
...
const Fullstack = ({ history }) => {
  ...
  const handleAccordionClick = (index) => {
    ...
    const settings = {
      ...
      const slides = [
        { id: 1, content: `I loved my journey through the Full Stack Development Course. The curriculum and projects helped me get placed. I am currently working as a data engineer and am using all the programming concepts I learnt during the course.`, author: 'Ahmed Khan, Full Stack Developer' },
        { id: 2, content: `It was a really good experience to do the Full Stack Development course from Campalin. I have really upskilled my knowledge and got an opportunity to work for one of the esteem companies. Thank you, Campalin, for really motivating me and guiding me to choose the correct career path.`, author: 'Rohan Malhotra, Lecturer' },
        {
            id:3 , content: `The web development upskilling provided a solid foundation in front-end and back-end development. I created responsive websites and gained practical coding skills.`,
            author: "Advait Patel, Full stack web developer"
        }
   ...
   const  isimge = window.innerWidth >= 784
    ...
    return (
        <Fragment>
                ...
                <Fragment>
                    <MetaData title="full-stack" />

                    <div className="main">
                          
                        <ScrollAnimation animateIn="fadeIn">
                            <div className="Box ">
                            <img src={"https://campalin.com/Courses/course%20thumbnails/FULL%20STACK%20THUMBNAIL.png"} className={isimge ? `absolute h-48 mt-28 ml-[750px] rounded-md` : `    h-52 mt-10  ml-5 rounded-md`} alt="Ethical Hacking" />
                                <div className="group"  >
  ...
  <div style={{ width: "100%", maxWidth: "600px", display: "flex", flexDirection: "column", alignItems: "center", marginRight:"150px" , marginBottom:"50px"}}>
    ...
    <img
      src="https://campalin.com/assets/images/projects-thumbnails/projects%20webdevelopment.png"
