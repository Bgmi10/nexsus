...
import Fullstackaccoridon from "./Datascienceaccordion.js";
...
const Datascience = ({ history }) => {
  ...
  const handleAccordionClick = (index) => {
    ...
    const settings = {
      ...
      const slides = [
        { id: 1, content: `“Learning with Campalin has been an experience like no other. Being an online program, you have your worries about how the program and teaching methods will be. My favourite part about the learning experience has been programming through well designed and thoughtful content shared by Mentors and industry experts on Campalin platform. Kudos to Campalin.”` ,
        author: 'Madishetti Nagendra, Data Science Engineer' },
        { id: 2, content: `You may not believe it but I had never done coding in my life. I did it during this course and was thrilled to see the outcomes coming out of those codes. Just the way I used to get happy after solving a good (tough) math problem during my school age. Thanks to Campalin for providing a great service to people like us who at the age of 43 can dream to study with budding talents around.`, author: 'Rakesh, Data Engineer' },
        {
            id:3 , content: `A very well-structured and well-balanced program content which you won’t get in other programs/nano-degrees. Being a beginner in DS, I found the structure of Executive Program from Campalin most helpful. They even teach you most of the prerequisites with prep sessions before you even start the course. Being a working professional, it was neither too difficult nor too easy to keep up with the pace of the course.`,
            author: "Seemadan, Data Analyst (Intern)"
        }
                ...
                <Fragment>
                    ...
                    <div className="main">
                        ...
                        <ScrollAnimation animateIn="fadeIn">
                            <div className="Box ">
                            <img src={"https://campalin.com/Courses/course%20thumbnails/data%20thumbnail.png"} className={isimge ? `absolute h-48 mt-28 ml-[750px] rounded-md` : `    h-52 mt-10  ml-5 rounded-md`}  alt="Ethical Hacking" />
                                <div className="group"  >
  ...
  <div style={{ width: "100%", maxWidth: "600px", display: "flex", flexDirection: "column", alignItems: "center", marginRight:"150px" }}>
    ...
    <img
      src="https://campalin.com/assets/images/projects-thumbnails/projects%20%20data%20science.png"
